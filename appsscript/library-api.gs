 ...
 * ━━ 어디에 붙나 ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 *
 *   라이브러리 프로젝트 : core.gs + zipcrypto.gs + 이 파일
 *   유저 프로젝트       : main.gs 하나 + 라이브러리 참조(식별자 KMoney)
 *
 * 개발 중에는 한 프로젝트에 전부 붙여넣어도 된다. main.gs 의 api_() 가
 * 라이브러리와 전역 둘 다에서 찾으므로 코드가 갈라지지 않는다.
 */
