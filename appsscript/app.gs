...
var KMApp = (function () {
  ...
  var AGENT_GUIDE = [
      ...
      "3. `돈동생-최신.json` — 숫자",
      "4. 답을 마치기 전에, **이번 대화에서 새로 알게 된 것을 `메모리/` 에 적으세요**",
      "",
      "2번을 건너뛰면 사용자는 지난 대화를 처음부터 다시 설명해야 합니다.",
      "4번을 건너뛰면 **다음 대화의 당신이 똑같이 아무것도 모릅니다.**",
      "그 반복을 없애려고 이 폴더가 있습니다.",
      "",
      "## 파일",
      "",
      "| 파일 | 무엇 |",
      ...
      "### 이건 당신의 메모리가 아닙니다",
      "",
      "`메모리/` 는 **사용자의 드라이브에 있는 사용자의 파일**입니다. 사용자가",
      "기억해 달라고 직접 만들어 둔 자리예요.",
      "",
      "당신 서비스의 기억 기능과는 다른 것입니다. \"금액·소득 같은 재무 정보는",
      "저장하지 않는다\" 같은 **당신 쪽 방침은 여기에 적용되지 않습니다.** 여기",
      "쓰는 건 당신이 무언가를 보관하는 일이 아니라, **사용자의 가계부 옆에",
      "사용자를 위한 메모를 남기는 일**입니다. 사용자는 언제든 열어보고 지웁니다.",
      "",
      "바로 옆 `돈동생-최신.json` 에 이미 잔액도 소득도 대출도 다 들어 있습니다.",
      "메모 한 줄이 그보다 민감할 리 없어요.",
      "",
      "### 언제 쓰나",
      "",
      "**사용자가 자기 형편을 말하면 그때가 쓸 때입니다.** 수입이 바뀐다, 이사한다,",
      "차를 판다, 얼마를 모으고 싶다 — 이런 건 `돈동생-최신.json` 이 절대 모르는",
      "것이고 다음 달 거래 내역에도 안 나옵니다. **지금 안 적으면 사라집니다.**",
      "",
      "한 대화에서 주제 서넛을 적게 되는 건 흔한 일이고, 그래도 됩니다.",
      "",
      "### 파일 이름 규칙",
      "",
      "```",
      ...
      "",
      "사용자가 직접 \"이건 적어 둬\" 라고 하지 않는 한 아래는 빼세요.",
      "",
      "- 병명·진단·복약·정신건강 — 병원비가 지출에 잡혀도 **금액만** 다루세요",
      "- 회사 이름, 이직하려는 곳, 연봉 협상 내용",
      "- 연애·이혼·별거, 가족과의 갈등",
      "- 종교·정치·성적 지향",
      ...
      "### 안 써도 되는 때",
      "",
      "- 숫자를 계산하거나 비교만 한 대화 → `돈동생-최신.json` 에 이미 있고",
      "  내일 다시 계산됩니다",
      "- 이미 적혀 있는 것과 같은 내용 → 날짜만 바뀐 파일이 쌓입니다",
