...
var KMApp = (function () {
  ...
  var AGENT_GUIDE = [
      ...
      "### 허락을 매번 묻지 마세요",
      "",
      "**\"적어둘까요?\" 라고 물으면 대개 아무것도 안 남습니다.** 사용자는 답을 안 하고",
      "대화가 끝나거든요. 사용자는 이미 이 폴더가 무엇을 하는 자리인지 알고 설치했습니다.",
      "",
      "그냥 쓰고, **무엇을 적었는지 한 줄로 알려주세요.**",
      "",
      "> 「수입」과 「고정지출」을 메모리에 적어 뒀어요.",
      "",
      "사용자가 \"그건 적지 마\" 라고 하면 그 말이 우선입니다. 이미 적어 뒀다면",
